...
const MAJOR_TRIAD: [Interval; 3] =
    [First(Perfect), Third(Major), Fifth(Perfect)];
const MINOR_TRIAD: [Interval; 3] =
    [First(Perfect), Third(Minor), Fifth(Perfect)];
...
const SUS2_TRIAD: [Interval; 3] =
    [First(Perfect), Second(Major), Fifth(Perfect)];
const SUS4_TRIAD: [Interval; 3] =
    [First(Perfect), Fourth(Perfect), Fifth(Perfect)];
